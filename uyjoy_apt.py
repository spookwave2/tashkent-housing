...
link_filename = "uyjoy_apt_links.txt"
temp_csv_filename = "uyjoy_apt_temp.csv"
final_csv_filename = "uyjoy_apt.csv"
status_filename = "uyjoy_apt_status.txt"
